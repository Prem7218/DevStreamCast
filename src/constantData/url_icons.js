import { Globe, Info, Mail, PlusCircle } from "lucide-react";
export const cors = "https://cors-anywhere.herokuapp.com/"; 
export const DEV_ARTICLE_API = "https://dev.to/api/articles?username=";
...
export const THE_NEWS_API = 'https://newsapi.org/v2/top-headlines?category=technology&apiKey=';
export const AVTAR = "https://iili.io/33jdF1e.png";
export const AVTAR_ID = () => `host@${Math.floor(100 + Math.random() * 900)}`;
