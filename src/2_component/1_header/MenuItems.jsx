        ...
        {isLogin && (
          <>
            ...
            <button
              ...
              className="space-x-2 p-2 rounded-md bg-white shadow-sm hover:bg-blue-100 transition duration-300"
            >
              <span className="text-gray-800 font-medium">Join DevMeet</span>
            </button>
          </>
        )}
