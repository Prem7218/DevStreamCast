              ...
              <div className="relative w-full h-48 bg-gray-200">
                ...
                <div className="absolute left-5 bottom-[-40px]">
                  <img
                    ...
                    alt="Profile"
                    className="w-24 h-24 md:w-28 md:h-28 rounded-full border-4 border-white shadow-lg cursor-pointer"
                  />
                </div>
              </div>
                ...
                <div className="flex items-center gap-3 mt-2">
                  ...
                  <button
                    ...
                    className={`px-5 py-2 rounded-md font-medium transition-all duration-300 ${
                      ...
                      !puid || puid === auth.currentUser?.uid
                        ? "hidden"
                        : "block"
                    }`}
                  >
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-600 ml-4">
                <Link to={qnsLen > 0 ? firstMeetingURL : "/profile"}>
                  <li>
                    <span className="font-medium text-gray-800">
                      <code>
                        {qnsLen > 0
                          ? "Join Meet"
                          : "You are already finished all meeting's..."}
                      </code>
                    </span>
                  </li>
                </Link>
